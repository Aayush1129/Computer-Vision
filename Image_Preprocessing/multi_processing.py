...
try:
    ...
    for file in final_list:
        ...
        process = multiprocessing.Process(target=preprocess,args = (img_name, state_2))
...
try:
    ...
    for file in final_list:
        ...
        process = multiprocessing.Process(target=merge_images, args=(folders, state_3))
        process_list2.append(process)
